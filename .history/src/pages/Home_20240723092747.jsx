import iconPerson from "../assets/Icon-Person1.png";
        ...
        <div className="delivering__content">
          ...
          <div className="delivering__quotes">
            <div className="delivering__quote">
              ...
              <img src={avatarAden} alt="Kady Baker" />
            </div>
            <div className="delivering__quote">
              <p>
              ...
              <img src={avatarDrake} alt="Aiysha Reese" />
            </div>
            <div className="delivering__quote">
              <p>
              ...
              <img src={avatarChristian} alt="Arthur Clarke" />
            </div>
          </div>
        </div>
      </section>
